    ...
    <div className="Home">
      ...
      <div className={styles.AllCategory}>
        <div className={styles.subCategory}>
          <HashLink
            to="/Menu#PERI_PERI_MATCH_SPECIALS"
        ...
        <div className={styles.subCategory}>
          <HashLink to="/Menu#CHICKEN_ROLLS" className={styles.CategoryName}>
            <img
              src="https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/categories/CAT170.jpg?ver=28.85"
              alt=""
            />
            <br></br>
            <br></br>
        ...
        <div className={styles.subCategory}>
          <HashLink to="/Menu#CHICKEN_BUCKETS" className={styles.CategoryName}>
            <img
              src="https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/categories/CAT86.jpg?ver=28.85"
              alt=""
            />
            <br></br>
            <br></br>
        ...
        <div className={styles.subCategory}>
          <HashLink to="/Menu#BIRYANI_BUCKETS" className={styles.CategoryName}>
            <img
              src="https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/categories/CAT190.jpg?ver=28.85"
              alt=""
            />
            <br></br>
            <br></br>
        ...
        <div className={styles.subCategory}>
          <HashLink to="/Menu#BOX_MEALS" className={styles.CategoryName}>
            <img
              src="https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/categories/CAT158.jpg?ver=28.85"
              alt=""
            />
            <br></br>
            <br></br>
        ...
        <div className={styles.subCategory}>
          <HashLink to="/Menu#BURGERS" className={styles.CategoryName}>
            <img
              src="https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/categories/CAT99.jpg?ver=28.85"
              alt=""
            />
            <br></br>
            <br></br>
        ...
        <div className={styles.subCategory}>
          <HashLink to="/Menu#SNACKS" className={styles.CategoryName}>
            <img
              src="https://orderserv-kfc-assets.yum.com/15895bb59f7b4bb588ee933f8cd5344a/images/categories/CAT89.jpg?ver=28.85"
              alt=""
            />
            <br></br>
            <br></br>
        ...
        <div className={styles.subCategory}>
          <HashLink to="/Menu" className={styles.CategoryName}>
            <img
              src="my-kfc/src/images/istockphoto-458531057-612x612.jpg"
              alt=""
            />
            <br></br>
            <br></br>
